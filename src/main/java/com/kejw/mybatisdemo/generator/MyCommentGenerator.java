...
public class MyCommentGenerator implements CommentGenerator {
	...
	public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
		...
		if (method.getName().indexOf("delete") >= 0) {
			method.addJavaDocLine(" * @Description: 删除");
		} else if (method.getName().indexOf("insert") >= 0) {
			method.addJavaDocLine(" * @Description: 新增");
		} else if (method.getName().indexOf("selectAll") >= 0) {
			method.addJavaDocLine(" * @Description: 查询全部");
		} else if (method.getName().indexOf("select") >= 0) {
			method.addJavaDocLine(" * @Description: 查询");
		} else if (method.getName().indexOf("update") >= 0) {
			method.addJavaDocLine(" * @Description: 修改");
		}
	...
	public void addJavaFileComment(CompilationUnit compilationUnit) {
		...
		// fendo公司");
		// compilationUnit.addFileCommentLine("* @date "+sdf.format(new
		// Date())+"");
		// compilationUnit.addFileCommentLine("*/");
	}
	 ...
	 */
	/*
	 * @Override public void addModelClassComment(TopLevelClass arg0,
	 * IntrospectedTable arg1) {
	 * 
	 * }
	 */
...
//					baseClass.substring(baseClass.lastIndexOf(".") + 1, baseClass.length())));
//		}
